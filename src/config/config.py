...
class Config:
    def __init__(self, args) -> None:
        ...
        self.gcn_outputsize = 200
        self.num_gcn_layers = 2
        #alegcn
        self.dep_hidden_dim = 200 # args.dep_hidden_dim
        self.pooling = 'avg' # args.pooling
        self.gcn_dim = 200 # args.gcn_dim
        self.num_gcn_layers = 2 # args.num_gcn_layers
        self.num_blocks = 2 # args.num_blocks
        self.num_sublayers = 4 # args.num_sublayers
        self.num_att_heads = 4 # args.num_att_heads
        self.gcn_mlp_layers = 0 # args.gcn_mlp_layers
        self.gcn_dropout = 0.5 # args.gcn_dropout
        self.adj_directed = 0 # args.gcn_adj_directed
        self.adj_self_loop = 0 # args.gcn_adj_selfloop
        self.edge_gate = 0 # args.gcn_gate
        self.label_weights = 5 # args.label_weights
        self.dep_emb_size = 50 #args.dep_emb_size
        #
        self.use_brnn = True
        ...
        # only ner Data specification
        self.nerdp_train_file = "data/" + args.nerdp_dataset + "/train.txt"
        self.nerdp_dev_file = "data/" + args.nerdp_dataset + "/dev.txt"
        self.nerdp_test_file = "data/" + args.nerdp_dataset + "/test.txt"
        # ner + dp Data specification
        self.ner_train_file = "data/" + args.ner_dataset + "/train.txt"
        self.ner_dev_file = "data/" + args.ner_dataset + "/dev.txt"
        self.ner_test_file = "data/" + args.ner_dataset + "/test.txt"
