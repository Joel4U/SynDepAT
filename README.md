...
| SynDepAT （w/o dep）-crf|  resume | bert-base-multilan-cased |96.03 |96.44  | 96.24 | bert-lr: 3e-5  other-lr: 1e-3  (lstm)enc_layers: 1, (lstm)shared_enc_nlayers: 3 |
| SynDepAT （w/o dep）-crf|  catalan  | bert-base-multilan-cased |  86.83 |86.98  | 86.90 | bert-lr: 2e-5  other-lr: 1e-3  (lstm)enc_layers: 1, (lstm)shared_enc_nlayers: 3 |
